...
@Getter
@Setter
public abstract class AuthUserAbstract extends AggregateRoot<AuthUserId> {
 ...
 public void setNotVerifiedToUserAuthority(AuthUserAbstract authUserAbstract){
  if(authUserAbstract.getUserRole().equals(AuthRole.NOT_VERIFIED)){
    authUserAbstract.setUserRole(authUserAbstract.userRole);
  }
