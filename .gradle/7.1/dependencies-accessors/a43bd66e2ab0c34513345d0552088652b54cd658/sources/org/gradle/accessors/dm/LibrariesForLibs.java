...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers) {
        ...
        /**
         * Creates a dependency provider for myslq (mysql:mysql-connector-java)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMyslq() { return create("myslq"); }
    ...
    public static class SpringLibraryAccessors extends SubDependencyFactory {
        ...
        public SpringLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for cloud (org.springframework.cloud:spring-cloud-dependencies)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCloud() { return create("spring-cloud"); }
