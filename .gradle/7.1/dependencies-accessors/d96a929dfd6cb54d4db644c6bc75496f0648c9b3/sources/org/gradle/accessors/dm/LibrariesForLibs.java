...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class SpringLibraryAccessors extends SubDependencyFactory {
        ...
        public SpringLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for boot (org.springframework.boot:spring-boot)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getBoot() { return create("spring-boot"); }

            /**
             * Creates a dependency provider for config (org.springframework.boot:spring-boot-autoconfigure)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getConfig() { return create("spring-config"); }
